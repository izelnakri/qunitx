...
describe('--before script tests', () => {
  it('--before works when it doesnt need to be awaited', async () => {
  ...
  it('--before works for --browser mode when it doesnt need to be awaited', async () => {
  ...
  it('--before works it needs to be awaited', async () => {
  ...
  it('--before works for --browser mode it needs to be awaited', async () => {
