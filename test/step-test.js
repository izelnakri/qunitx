...
module('assert.step', function () {
  ...
  //   test('errors if not called when `assert.step` is used', function (assert) {
  //     assert.expect(2);
  //     assert.step('one');
  ...
  // module('assert.verifySteps value reference', function () {
  ...
  //   test('passing test to see if steps array is passed by reference to logging function', function (assert) {
  ...
  //   test('steps array should not be reset in logging function', function (assert) {
