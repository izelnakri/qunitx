...
export default async function() {
  ...
  let targetFilePath = `${projectRoot}/${process.argv[2]}.ts`; // if 3 params get from second the path or make dasherized 'test/test-module-name'
  let moduleName = process.argv[3] || process.argv[2]; // TODO: classify the module, implement 3rd argument
  ...
  console.log(kleur.green.bold(`${targetFilePath}.ts written`));
}
